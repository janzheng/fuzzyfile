...
import { downloadFileBuf, handleSearchParams, handleAddFile, handleGetFile, handleListFile, handleDownloadFile } from './helpers.js'
...
export const putHandler = async (request, key) => {
//   if (key) {
